        ...
        <el-dialog :title="title" :visible.sync="dialogVisible" :center="true" :fullscreen="true" :modal="false">
            <el-form class="order-form" :model="form" label-width="85px" :inline="true" style="width:100%;" size="mini">
                <el-row :gutter="0">
                    ...
                    <el-col :span="6">
                        <el-button type="primary" @click="saveOrder(1)">{{_label("tijiao")}}</el-button>
                        <el-button type="primary" @click="saveOrder(2)">{{_label("yushou")}}</el-button>
    ...
    methods: {
        ...
        saveOrder(flag) {
            ...
            params.list = self.tabledata.map(item => {
                return { productid: item.productid, sizecontentid: item.sizecontentid, number: item.select_number, orderdetailsid:item.orderdetailsid }
            })
