<template>
  <div>
    <el-form ref="order-form" class="formx" :model="form" label-width="100px" :inline="true" style="width:100%;" size="mini" :rules="formRules" :inline-message="false" :show-message="false">
      <el-row :gutter="0">
        <asa-button auth="order-submit" :enable="form.status!='2'" @click="saveOrder(1)">{{_label("baocun")}}</asa-button>
      ...
      <el-row :gutter="0">
        ...
        <el-col :span="4" style="width:250px">
          <el-form-item :label="_label('beizhu')" label-width="50">
    ...
    <sp-dialog ref="select-dialog" :min-height="50" :width="1100">
        ...
        <el-row :gutter="0">
          <el-col :span="8" style="width:300px">
            <el-form-item :label="_label('xiaoshouriqi')">
              <el-date-picker v-model="searchform.date" type="daterange" range-separator="~" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd"></el-date-picker>
            </el-form-item>
      ...
      <el-table ref="selectTable" :data="receives" stripe border style="width:100%;" max-height="400" @selection-change="onSelectionChange" @row-click="onRowClick">
