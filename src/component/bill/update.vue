...
export default {
  ...
  data() {
    ...
    return {
      ...
      props: {
        columns: [
          { name: "enterdate", label: _label("huikuanriqi"), type: 'date', width: 110, default: _label('_date') },
          { name: "currencyid", label: _label("bizhong"), type: 'select', source: "currency", width: 90, sortable: false, default: '', disabled: true },
          ...
          { name: "createstaff", label: _label("tijiaoren"), type: 'select', source: "user", is_edit_hide: true, width: 130 },
        ],
