...
<el-dialog :title="labels[action_type][0]" :visible.sync="dialogVisible" :center="true" width="1000px">
  <el-tabs type="border-card" @tab-click="onTabClick">
    <el-tab-pane :label="globals.getLabel('user-setting')">
        ...
        <el-row>
          ...
          <el-col :span="14">
            <el-form ref="form" :model="form" label-width="80px" size="mini">
              ...
              <el-form-item :label="globals.getLabel('guojima')">
              ...
              <el-form-item :label="globals.getLabel('huohao')">
        ...
        <el-row :gutter="0">
          ...
          <el-col :span="8">
            ...
            <el-form-item :label="globals.getLabel('chuchangjia')">
            ...
            <el-form-item :label="globals.getLabel('guojilingshoujia')">
            ...
            <el-form-item :label="globals.getLabel('guoneilingshoujia')">
              <el-input v-model="form.nationalprice"></el-input>
            </el-form-item>


            <el-form-item :label="globals.getLabel('chicunbeizhu')">
              <el-input v-model="form.ulnarinch_memo"></el-input>
            </el-form-item>
        </el-col>
            <el-col :span="8">
                <el-form-item :label="globals.getLabel('xingbie')">
                  <select-dialog v-model="form.gender" source="gender" style="width:150" :lang="lang">
                  </select-dialog>
                </el-form-item>

                <el-form-item :label="globals.getLabel('jijie')">
                  <select-dialog v-model="form.season" source="season" style="width:150" :lang="lang">
                  </select-dialog>
                </el-form-item>

                <el-form-item :label="globals.getLabel('chima')">
                  <simple-select v-model="form.sizetopid" source="sizetop" :lang="lang">
                  </simple-select>
                </el-form-item>

                <el-form-item :label="globals.getLabel('chimaguige')">
                  <simple-select v-model="form.ulnarinch" source="sizetop" :lang="lang">
                  </simple-select>
                </el-form-item>

             <el-form-item :label="globals.getLabel('zhixingbiaozhun')">
              <simple-select v-model="form.ulnarinch" source="sizetop" :lang="lang">
              </simple-select>
            </el-form-item>

            <el-form-item :label="globals.getLabel('anquanleibie')">
              <simple-select v-model="form.ulnarinch" source="sizetop" :lang="lang">
              </simple-select>
            </el-form-item>

            <el-form-item :label="globals.getLabel('guigexinghao')">
              <el-input v-model="form.password"></el-input>
            </el-form-item>

            <el-form-item :label="globals.getLabel('zuihouruku')">
              <el-input v-model="form.password"></el-input>
            </el-form-item>

            <el-form-item :label="globals.getLabel('jiandangshijian')">
              <el-input v-model="datetime" disabled></el-input>
            </el-form-item>

            <el-form-item :label="globals.getLabel('jiandangren')">
    ...
    <el-tab-pane :label="globals.getLabel('shangpintupian')">
