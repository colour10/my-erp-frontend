<template>
  <div>
    ...
    <el-dialog class="user-form user-dialog" :title="_label('yonghuxinxi')" :visible.sync="dialogVisible" :center="true" width="700px">
      <el-tabs type="border-card" @tab-click="onTabClick" activeName="user">
        <el-tab-pane :label="_label('user-setting')" name="user">
          <el-form ref="order-form" class="order-form" :model="form" label-width="85px" :inline="true" style="width:700px;" size="small" :rules="formRules" :inline-message="false" :show-message="false">
            <el-col :span="11">
