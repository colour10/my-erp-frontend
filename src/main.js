...
const routes = [
    {
        ...
        children: [
            ...
            },
            {
                path: '/shipping',
                name: "shipping",
                component: resolve => require(['./component/shipping/index.vue'], resolve)
            },
            {
                path: '/shipping/:id',
                name: "shippingdetail",
            ...
            },
            {
                path: '/sizetop',
                name: "sizetop",
                component: resolve => require(['./component/sizetop/index.vue'], resolve)
            },
            ...
            {path: '/develop', name: "develop", component: Creator},
            {
                path: '/supplier',
                name: "supplier",
                component: resolve => require(['./component/supplier/index.vue'], resolve)
            },
            {
                path: '/exchangerate',
                name: "exchangerate",
            ...
            },
            {
                path: '/order/:id',
                name: "orderform",
                component: resolve => require(['./component/order/create.vue'], resolve)
            },
            {
                path: '/ordersimple/:id',
            ...
            },
            {
                path: '/bill/:id',
                name: "billedit",
                component: resolve => require(['./component/bill/update.vue'], resolve)
            },
            ...
            {path: '/materialstatus', name: "materialstatus", component: getComponent("materialstatus")},
            {
                path: '/material',
                name: "material",
                component: resolve => require(['./view/material/index.vue'], resolve)
            },
