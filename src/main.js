...
const routes = [
    {
        ...
        children:[
            ...
            {path: '/shipping/:id', name:"shippingdetail", component:resolve=>require(['./component/shipping/create.vue'],resolve) },
            ...
            {path: '/product/edit/:id', name:"productEdit", component: resolve=>require(['./view/product/edit.vue'],resolve) },
