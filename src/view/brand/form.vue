<template>
    <el-form class="user-form" ref="form" :model="form" label-width="100px" size="mini" :rules="rules" :show-message="false">
...
export default {
    ...
    data() {
        return {
            rules: {
                'name_en': [{required: true, message: showLabel('pinpaimingcheng') + showLabel('required'), trigger: 'blur'}]
            },
            countries: [],
