        ...
        <el-row :gutter="0">
          <el-col :span="8">
            ...
            <el-form-item :label="showLabel('pinlei')" prop="form.brandgroupid">
              <el-select v-model="product.form.brandgroupid" placeholder="" size="mini"
            ...
            <el-form-item :label="showLabel('zipinlei')" prop="form.childbrand">
              <el-select v-model="product.form.childbrand" placeholder="" size="mini">
                <el-option
        ...
        methods: {
            ...
            getProductRelatedOptions() {
                ...
                self._fetch("/product/getProductRelatedOptions", {}).then(function (res) {
                    ...
                    self.categories.forEach((item) => {
                        // 因为类型不同，这里不要用三等号
                        if (item.id == self.product.form.brandgroupid) {
            ...
            getChildbrandMenus() {
                this.categories.forEach((item) => {
                    // 因为类型不同，这里不要用三等号
                    if (item.id == this.product.form.brandgroupid) {
            ...
            handleChangeBrandgroupid() {
                // 修改下面的子品类为空
                this.product.form.childbrand = '==请选择子品类=='
                this.getChildbrandMenus()
            }
        }
    }
